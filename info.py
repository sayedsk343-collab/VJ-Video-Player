...
API_ID = int(environ.get('API_ID', '34293127'))
API_HASH = environ.get('API_HASH', '42df8a93576cdde1ff8536bf1cee5cea')

# Bot Token, This Is Main Bot
BOT_TOKEN = environ.get('BOT_TOKEN', "")

# Admin Telegram Account Id For Withdraw Notification Or Anything Else
ADMIN = int(environ.get('ADMIN', '6797047863'))
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003238788128'))
...
LINK_URL = environ.get("LINK_URL", "https://anime1video.blogspot.com/p/a.html")
